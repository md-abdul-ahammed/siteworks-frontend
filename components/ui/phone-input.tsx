    ...
    ({ className, onChange, value, countries, ...props }, ref) => {
      return (
        <RPNInput.default
          ...
          countrySelectComponent={(props) => <CountrySelect {...props} allowedCountries={countries} />}
...
const CountrySelect = ({
  ...
  // Filter countries based on allowed countries list
  const filteredCountries = allowedCountries 
    ? countryList.filter(country => 
        country.value && allowedCountries.includes(country.value)
      )
    : countryList;
